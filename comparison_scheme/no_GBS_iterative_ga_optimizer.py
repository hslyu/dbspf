...
num_parents_mating = args.num_ue//4 # Number of solutions to be selected as parents in the mating pool.
sol_per_pop = args.num_ue # Number of solutions in the population.
