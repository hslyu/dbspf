...
num_parents_mating = max(10, args.num_ue//4) # Number of solutions to be selected as parents in the mating pool.
sol_per_pop = max(args.num_ue, 20) # Number of solutions in the population.
