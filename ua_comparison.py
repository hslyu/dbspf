...
for env_idx in range(num_env):
    ...
    for i in range(NUM_UE):
        ...
        user = User(i, # id
                ...
                datarate, INITIAL_DATA*random.random(), MAX_DATA) # data
    ...
    reward += (root.get_reward(niter)-reward)/(env_idx+1)

#    print(f'Current step: {env_idx} with relative reward {reward_local/reward_opt:.4f}, {reward_local=:.4f}, {reward_opt=:.4f}')
    print(f'Current step: {env_idx} with relative {reward=}')
